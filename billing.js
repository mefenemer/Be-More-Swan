...
(function () {
    ...
    function _subscriptionCard(sub) {
        ...
        // ── Voucher ────────────────────────────────────────────────────────────────
        // Previously the page showed only the headline price, with no sign a voucher was in play:
        // a customer paying £39.50 under a 50% code still saw "£79.00". `sub.discount` comes from
