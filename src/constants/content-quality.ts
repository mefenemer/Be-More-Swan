...
- NO RECURRING CATCHPHRASES. Beyond the hook, do not reuse signature lines or stock phrases from recent posts — e.g. "the work only you can do", "no YouTube tutorials at 11pm", "in two clicks", the same "No X. No Y. No Z." triplet, or an identical sign-off/CTA. A reader seeing several of your posts should not spot the same catchphrases each time. Find fresh wording for the same idea.
