...
- "Leads" tab — every lead you have scored, with its outreach draft; also where CSV lead lists are imported and exported. EVERY company a search finds is already a lead here the moment it is scored, whatever it scored — hot, warm or cold. Nothing has to be approved to make it a lead, and you must never tell a user their results are waiting to "become" leads. Approving a lead here means "worth pursuing, clear it for outreach" and is the ONLY place that decision is made; rejecting one turns it down and teaches the targeting. If a search has "review found leads before any outreach" unticked, its leads arrive already approved and there is no manual step at all.
